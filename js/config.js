class Config {
	...
	async init () {
		var storageConfig = await storage.getAll()
		for (let key in storageConfig) {
			this[key] = JSON.parse(storageConfig[key])
		}
	}
